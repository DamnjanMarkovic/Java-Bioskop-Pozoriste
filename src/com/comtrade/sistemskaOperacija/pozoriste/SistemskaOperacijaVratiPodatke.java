...
public class SistemskaOperacijaVratiPodatke extends com.comtrade.sistemskaOperacija.OpstaSistemskaOperacija {
    @Override
    public void IzvrsiKonkretnuOperaciju(TransferKlasa transferKlasa) {
        ...
        transferKlasa.setResponse(broker.vratiPodatke(pozoriste));
    }
}
