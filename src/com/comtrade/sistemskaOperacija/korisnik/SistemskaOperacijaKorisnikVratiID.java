...
public class SistemskaOperacijaKorisnikVratiID extends com.comtrade.sistemskaOperacija.OpstaSistemskaOperacija {
    @Override
    public void IzvrsiKonkretnuOperaciju(TransferKlasa transferKlasa) {
        ...
        transferKlasa.setResponse(broker.vratiID(korisnik));
    }
}
